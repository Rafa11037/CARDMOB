...
//Indicar o ednereço do backend.
const BASE_URL = 'http://10.81.205.36:3000'

export default function App() {
  // Excluir tudo que tem relação com counter, pois não vou usar.
  ...
  const addItem = async () => {
    ...
    // READ -> um único e/ou lista de itens
